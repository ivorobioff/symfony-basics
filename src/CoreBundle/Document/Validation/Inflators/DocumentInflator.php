<?php
namespace CoreBundle\Document\Validation\Inflators;

use CoreBundle\Document\Entities\Document;
use CoreBundle\Document\Services\DocumentService;
use CoreBundle\Document\Validation\Rules\DocumentExists;
use CoreBundle\Document\Validation\Rules\DocumentPermissions;
